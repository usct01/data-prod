# -*- coding: utf-8 -*-
"""Data_prod_insightss.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1k-r5yJkr9eVvSzxwPMMQp3aFQPzhOyy5
"""
...
#     color_theme_list = ['Blues', 'Cividis', 'Greens', 'Magma', 'Plasma', 'Reds', 'Rainbow', 'Turbo']
...
#         st.write(filtered_df_ccaller[['Caller_Emotion', 'Receiver', 'Timestamp', 'call_weekday', 'CallerContent']])
# 
#         # Heatmap
...
#         st.pyplot(fig)
# 
#         # Create a donut chart for call_weekday
#         st.write("### Donut Chart of Call Weekday for Receiver")
#         call_weekday_counts = filtered_df_receiver['call_weekday'].value_counts()
#         fig, ax = plt.subplots()
#         ax.pie(call_weekday_counts, labels=call_weekday_counts.index, autopct='%1.1f%%', startangle=90, wedgeprops=dict(width=0.2))
#         ax.axis('equal')
#         st.pyplot(fig)
#     else:
